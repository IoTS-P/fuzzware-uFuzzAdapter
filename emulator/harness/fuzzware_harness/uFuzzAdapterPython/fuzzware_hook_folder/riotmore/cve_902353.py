...
def check_call(uc, address, size, user_data):
    symbol_function = {
        ...
        0x20f928: on_24819,# bl memcpy
        0x20fc02: on_24820,# subs       ext_len,ext_len,r4
        0x20d674: on_24821,# add.w      r9,rfrag,#0x4
        0x20f176: on_24822,# mov        tmp,r6
        0x20f12e: on_24823,# adds       dispatch_size,#0x8
